...
CarInventory& sdds::CarInventory::setInfo(const char* typeCar, const char* brandCar, const char* modelCar, int yearCar, int codeCar, double carPrice)
{
	delete[] type;
	delete[] brand;
	delete[] model;
...
void sdds::CarInventory::printInfo() const
{
	cout << left 
		<< "| " 
		<< setw(10) 
...
bool sdds::CarInventory::issimilarto(const CarInventory& car) const
{
